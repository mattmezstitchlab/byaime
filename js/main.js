...
(function () {
  ...
  var moduleRegistry = {
    ...
    tables: { id: 'tables', name: 'Plan de table interactif', category: 'Coordination', description: 'Plan spatial animé avec recherche de table par prénom et composition des convives.', whyRecommended: 'Évite les attroupements devant les panneaux papier le soir du dîner.', icon: '🍽️', compatibleEvents: ['mariage', 'anniversaire', 'professionnel'], dependencies: ['guests'], optional: true, defaultEnabled: true },
    ...
    tributes: { id: 'tributes', name: 'Espace d\'hommage & Biographie', category: 'Mémoire', description: 'Biographie intime, portrait lumineux et citations choisies en hommage.', whyRecommended: 'Honore une vie avec délicatesse, dignité et poésie.', icon: '🕯️', compatibleEvents: ['ceremonie'], dependencies: [], optional: true, defaultEnabled: true },
    testimonials: { id: 'testimonials', name: 'Recueil de condoléances & Récits', category: 'Émotion', description: 'Espace sécurisé où chaque proche peut partager un souvenir ou mot de réconfort.', whyRecommended: 'Rassemble l\'affection de tous, y compris des proches éloignés.', icon: '🕊️', compatibleEvents: ['ceremonie', 'association'], dependencies: [], optional: true, defaultEnabled: true },
